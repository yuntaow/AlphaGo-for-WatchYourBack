# implement-alphaGo-in-watchyourback


Many thanks to Google's original paper on alphazero(and the cheat sheet).Many thanks to Siraj Raval and the author of the repository(https://github.com/suragnair/alpha-zero-general). Thanks for their inspirations. I finally take my courage to learn and implement the Alphazero. 
